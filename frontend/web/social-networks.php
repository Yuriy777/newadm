...
if (isset($_GET['params'])) {
    ...
    //$result = file_get_contents('http://www.kmitserver.com/crazysob/user/csob_system_get_recipe?api_key=7GjmGVQz85q6bz8q&recipe_id=recipe_id1097');
...
function makePage($result)
{
    ...
    $html .= '<meta property="og:image" itemprop="image" content="' . $result['title_image'] . '"/>' . PHP_EOL;
